        ...
        <div className="navbar-box flex justify-between items-center">
          <div className="logo">
            <h1 className="text-2xl font-bold px-4">
              <Link to="/" className="text-gray-950 dark:text-white">Analisis Sentimen</Link>
            </h1>
          </div>
          
          {/* Menu untuk Desktop */}
          <ul className="hidden lg:flex lg:gap-12 gap-8">
            <li><Link to="/" className="font-medium opacity-75 text-gray-950 dark:text-gray-100">Home</Link></li>
            <li><Link to="/analisis" className="font-medium opacity-75 text-gray-950 dark:text-gray-100">Analisis</Link></li>
            <li><Link to="/about" className="font-medium opacity-75 text-gray-950 dark:text-gray-100">About</Link></li>
          </ul>
          ...
          <div className="lg:hidden relative">
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg py-2 z-20 mx-auto">
                <Link to="/" className="block px-4 py-2 text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700">Home</Link>
                <Link to="/analisis" className="block px-4 py-2 text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700">Analisis</Link>
                <Link to="/about" className="block px-4 py-2 text-gray-900 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700">About</Link>
              </div>
            )}
          </div>
